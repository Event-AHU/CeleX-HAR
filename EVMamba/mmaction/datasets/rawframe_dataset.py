...
class RawframeDataset(BaseActionDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for line in fin:
            line_split = line.strip().split()  # ['frame_dir', 'name', 'class']
            video_info = {}
            idx = 0
            # idx for frame_dir
            ...
            ###### voxel_dir #######
            if self.data_prefix['voxel'] is not None:
                voxel_dir = self.data_prefix['voxel']
                video_info['voxel_dir'] = voxel_dir
